...
<div class="home">
    ...
    <router-link :to="'/song/' + song._id" tag="div" class="song" v-for="(song,index) in getAllSongs[0]" :key="index">
        ...
        <div class="song_likes">
          <img class="song_likes-icon" src="../assets/icons/favourite.svg" alt="">
