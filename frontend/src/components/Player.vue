<template>
<div>
        <img class="player-background" :src="'http://localhost:3000/api/song/' + $route.params.id + '/image'" alt="">
        <div class="player-buttons">
        <div @click.capture="playSong" v-bind:data-source="'http://localhost:3000/api/song/' + 
